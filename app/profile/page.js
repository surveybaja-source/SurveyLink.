...
function InsurerProfile({profile, user}) {
  ...
  const SecT = ({text}) => (
    <div style={{color:'#8fa8c0',fontWeight:700,fontSize:13,letterSpacing:'0.08em',textTransform:'uppercase',margin:'20px 0 12px',paddingBottom:8,borderBottom:'1px solid #1e3a52'}}>{text}</div>
  )
  ...
  return (
    <div style={{background:'#0c1a27',minHeight:'100vh'}}>
      ...
      <nav style={{background:'#0f1e2e',borderBottom:'1px solid #1e3a52',padding:'0 32px',height:58,display:'flex',alignItems:'center',justifyContent:'space-between',position:'sticky',top:0,zIndex:100}}>
        <span style={{color:'#fff',fontWeight:900,fontSize:22,letterSpacing:'0.05em'}}>INSPE<span style={{color:'#dd2e1e'}}>LINK</span></span>
      ...
      <div style={{maxWidth:700,margin:'0 auto',padding:'32px 24px'}}>
        <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:32,padding:24,background:'#132030',border:'1px solid #1e3a52',borderRadius:12}}>
          <div style={{width:64,height:64,borderRadius:'50%',background:'linear-gradient(135deg,#182e44,#dd2e1e)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:24,fontWeight:800,color:'#fff'}}>🏢</div>
          <div>
        ...
        <div style={{background:'#132030',border:'1px solid #1e3a52',borderRadius:12,padding:28}}>
          ...
          <div style={{marginTop:8}}>
            <div style={{background:'rgba(221,46,30,0.08)',border:'1px solid #dd2e1e',borderRadius:8,padding:'11px 14px',marginBottom:16,display:'flex',gap:10}}>
              <span>ℹ️</span>
              <span style={{color:'#8fa8c0',fontSize:11,lineHeight:1.5}}>To update your email address or legal documents, please contact support@inspelink.com</span>
            </div>
      ...
      <div style={{maxWidth:700,margin:'0 auto',padding:'32px 24px'}}>
        <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:32,padding:24,background:'#132030',border:'1px solid #1e3a52',borderRadius:12}}>
          ...
          <div style={{textAlign:'right'}}>
            ...
            <div style={{color:'#dd2e1e',fontWeight:800,fontSize:20}}>{coverage.length}</div>
        ...
        <div style={{background:'#132030',border:'1px solid #1e3a52',borderRadius:12,padding:28}}>
          ...
          {activeTab==='coverage'&&(
            <div>
              ...
              <p style={{color:'#8fa8c0',fontSize:12,marginBottom:16,lineHeight:1.6}}>Select all countries where you are available to conduct surveys.</p>
          ...
          {activeTab==='banking'&&(
            <div>
              ...
              <div style={{background:'rgba(221,46,30,0.08)',border:'1px solid #dd2e1e',borderRadius:8,padding:'11px 14px',marginBottom:14,display:'flex',gap:10}}>
                <span>ℹ️</span>
                <span style={{color:'#8fa8c0',fontSize:11,lineHeight:1.5}}>To update your email address or legal documents, please contact support@inspelink.com</span>
              </div>
            </div>
