    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#0f1e2e;margin:0 0 16px;">New Quote Received</h2>
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          ...
          <a href="${process.env.NEXT_PUBLIC_APP_URL||'https://inspelink.com'}/dashboard"
            style="display:inline-block;background:#0f1e2e;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:700;margin-top:8px;">
            View Dashboard
          </a>
          <p style="color:#999;font-size:12px;margin-top:24px;">INSPELINK — Marine Cargo Survey Platform</p>
        </div>
  ...
  newMissionAvailable: (missionRef, cargoType, location, urgency) => ({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#0f1e2e;margin:0 0 16px;">New Survey Request Available</h2>
          <p style="color:#555;line-height:1.6;">A new survey request matching your expertise is available.</p>
          <div style="background:#f8f9fa;border-left:4px solid #0f1e2e;padding:16px;margin:20px 0;border-radius:0 8px 8px 0;">
  ...
  reportUploaded: (missionRef, reportType, surveyorName) => ({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#0f1e2e;margin:0 0 16px;">New Report Available</h2>
  ...
  convocation: (data) => ({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:0 auto;padding:32px;background:#fff;color:#333;">
        <div style="background:#0f1e2e;padding:20px 24px;border-radius:8px 8px 0 0;margin-bottom:24px;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#dd2e1e;">LINK</span></span>
        </div>
