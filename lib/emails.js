...
export const emailTemplates = {
  newQuoteReceived: (missionRef, surveyorName, amount) => ({
    subject: `INSPELINK — New quote received for ${missionRef}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        </div>
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#2a2520;margin:0 0 16px;">New Quote Received</h2>
          <p style="color:#555;line-height:1.6;">You have received a new quote for mission <strong>${missionRef}</strong>.</p>
          <div style="background:#f8f9fa;border-left:4px solid #C4503A;padding:16px;margin:20px 0;border-radius:0 8px 8px 0;">
          ...
          <a href="${process.env.NEXT_PUBLIC_APP_URL||'https://inspelink.com'}/dashboard"
            style="display:inline-block;background:#C4503A;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:700;margin-top:8px;">
            Review Quote
          </a>
  ...
  quoteAccepted: (missionRef, cargoType, location) => ({
    subject: `INSPELINK — Your quote has been accepted for ${missionRef}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
  ...
  quoteDeclined: (missionRef, reason) => ({
    subject: `INSPELINK — Your quote was declined for ${missionRef}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#C4503A;margin:0 0 16px;">Quote Declined</h2>
          <p style="color:#555;line-height:1.6;">Your quote for mission <strong>${missionRef}</strong> has been declined.</p>
          <div style="background:#fff5f5;border-left:4px solid #C4503A;padding:16px;margin:20px 0;border-radius:0 8px 8px 0;">
            <p style="margin:0;color:#333;"><strong>Reason:</strong> ${reason}</p>
          </div>
          <a href="${process.env.NEXT_PUBLIC_APP_URL||'https://inspelink.com'}/dashboard"
            style="display:inline-block;background:#2a2520;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:700;margin-top:8px;">
            View Dashboard
          </a>
          <p style="color:#999;font-size:12px;margin-top:24px;">INSPELINK — Marine Cargo Survey Platform</p>
        </div>
  ...
  counterProposal: (missionRef, counterText, originalAmount) => ({
    subject: `INSPELINK — Counter-proposal received for ${missionRef}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#8B6F47;margin:0 0 16px;">Counter-Proposal Received</h2>
          <p style="color:#555;line-height:1.6;">The insurer has sent a counter-proposal for mission <strong>${missionRef}</strong>.</p>
          <div style="background:#fffbf0;border-left:4px solid #8B6F47;padding:16px;margin:20px 0;border-radius:0 8px 8px 0;">
          ...
          <a href="${process.env.NEXT_PUBLIC_APP_URL||'https://inspelink.com'}/dashboard"
            style="display:inline-block;background:#8B6F47;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:700;margin-top:8px;">
  ...
  newMissionAvailable: (missionRef, cargoType, location, urgency) => ({
    subject: `INSPELINK — New survey request available: ${cargoType}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#2a2520;margin:0 0 16px;">New Survey Request Available</h2>
          <p style="color:#555;line-height:1.6;">A new survey request matching your expertise is available.</p>
          <div style="background:#f8f9fa;border-left:4px solid #2a2520;padding:16px;margin:20px 0;border-radius:0 8px 8px 0;">
  ...
  reportUploaded: (missionRef, reportType, surveyorName) => ({
    subject: `INSPELINK — New ${reportType} report uploaded for ${missionRef}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        ...
        <div style="background:#fff;padding:32px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0;">
          <h2 style="color:#2a2520;margin:0 0 16px;">New Report Available</h2>
  ...
  finalReportUploaded: (missionRef, surveyorName) => ({
    subject: `INSPELINK — Mission ${missionRef} completed — Final report available`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f8f9fa;padding:32px;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
  ...
  convocation: (data) => ({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:0 auto;padding:32px;background:#fff;color:#333;">
        <div style="background:#2a2520;padding:20px 24px;border-radius:8px 8px 0 0;margin-bottom:24px;">
          <span style="color:#fff;font-size:20px;font-weight:900;letter-spacing:0.05em;">INSPE<span style="color:#C4503A;">LINK</span></span>
        </div>
